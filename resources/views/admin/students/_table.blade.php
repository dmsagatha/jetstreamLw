<table class="min-w-full divide-y divide-gray-200">
  <thead class="bg-gray-50 text-center text-sm font-bold align-middle">
    <tr>
      <th></th>
      <th scope="col" class="w-24 px-6 py-3 text-gray-500 uppercase tracking-wider cursor-pointer">
        ID
      </th>
      ...
      <th scope="col" class="px-6 py-3 text-gray-500 uppercase tracking-wider">
        Acciones
      </th>
    </tr>
  </thead>
