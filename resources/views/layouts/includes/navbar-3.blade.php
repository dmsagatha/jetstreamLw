<header class="flex fixed w-full bg-white">
  <div x-data="{ openNavbar: false }"
    class="w-full mx-auto flex-wrap items-center justify-between p-3 z-10 top-0 inset-x-0 py-3">
    <div class="relative flex items-center justify-between h-16">
      <!-- Icono Sidebar, Logotipo y Menú de navegación izquierdo -->
      <div class="flex-1 flex sm:items-stretch sm:justify-start">
        ...
        <nav :class="openNavbar ? 'show' : 'hidden'"
          class="w-full flex-grow md:flex md:items-center md:w-auto md:pt-0 absolute md:relative top-16 md:top-0 left-0 bg-gray-100">
          <ul class="md:flex justify-end flex-1 items-center">
            <li class="mr-4 my-2 md:my-0">
              <a href="#!"
                class="block py-1 md:py-3 pl-1 align-middle border-b-2 border-white hover:border-green-600 hover:text-lime-700">Inicio</a>
            </li>
            <li class="mr-4 my-2 md:my-0">
              <a href="#!"
                class="block py-1 md:py-3 pl-1 align-middle border-b-2 border-white hover:border-green-600 hover:text-lime-700">Acerca</a>
            </li>
            <li class="mr-4 my-2 md:my-0">
              <a href="#!"
                class="block py-1 md:py-3 pl-1 align-middle border-b-2 border-white hover:border-green-600 hover:text-lime-700">Servicios</a>
            </li>
            <li class="mr-4 my-2 md:my-0">
              <a href="#!"
                class="block py-1 md:py-3 pl-1 align-middle border-b-2 border-white hover:border-green-600 hover:text-lime-700">Contacto</a>
            </li>
            <li class="mr-4 my-2 md:my-0">
              <a href="#!"
                class="block py-1 md:py-3 pl-1 align-middle border-b-2 border-white hover:border-green-600 hover:text-lime-700">Usuarios</a>
            </li>
          </ul>
        </nav>
      </div>
      ...
      <div x-data="{ dropdownOpen: false }" class="relative">
        ...
        <div class="absolute right-0 mt-2 w-48 bg-white rounded-md overflow-hidden shadow-xl z-10" x-show="dropdownOpen"
          ...
          <a href="" class="block px-4 py-2 text-sm text-gray-700 hover:bg-purple-600 hover:text-white">Logout</a>
        </div>
      </div>
      <!-- Menú de navegación derecho -->
