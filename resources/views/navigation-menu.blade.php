<nav x-data="{ open: false }" class="fixed top-0 inset-x-0 z-50 bg-white border-b border-gray-100">
  ...
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    <div class="flex justify-between h-16">
      <div class="flex">
        ...
        <!-- Menú desplegable -->
        <div class="flex items-center px-2 py-4 bg-gray-300 cursor-pointer group relative">
          <span><i class="fas fa-bars"></i></span>
          <span class="capitalize ml-2">Todos los Crud's</span>

          <div
            class="absolute w-full left-0 top-full bg-white shadow-md py-3 invisible opacity-0 group-hover:opacity-100 group-hover:visible transition duration-300 z-50 divide-y divide-gray-300 divide-dashed">
            ...
            <a class="flex items-center px-4 py-3 hover:bg-gray-100 transition" href="{{ route('students') }}">
      ...
      <div class="hidden sm:flex sm:items-center sm:ml-6">
        ...
        <div class="ml-3 relative group">
          <x-jet-dropdown align="right" width="48" class="hidden group-hover:block">
            <x-slot name="trigger">
  ...
  <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
    <div class="pt-2 pb-3 space-y-1">
      ...
      <x-jet-responsive-nav-link href="{{ route('user.list') }}" :active="request()->routeIs('user.list')">
        {{ __('Users') }}
      </x-jet-responsive-nav-link>
